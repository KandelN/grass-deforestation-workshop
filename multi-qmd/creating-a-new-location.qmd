...
[This search](https://spatialreference.org/ref/?search=nlcd) will give a list of spatial references that mention NLCD.  
...
1. Manually construct projection parameters for GRASS
