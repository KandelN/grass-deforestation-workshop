...
For example, [QGIS](https://qgis.org/), another open-source GIS, implements a processing provider system that can borrow third-party GIS modules such as GRASS GIS and [SAGA GIS](https://saga-gis.sourceforge.io/).  
